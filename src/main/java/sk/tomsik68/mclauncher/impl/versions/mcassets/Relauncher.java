...
public class Relauncher {
    public static void main(String[] args) {
        try {
             ...
             * ArgumentAcceptingOptionSpec<String> userNameOption =
             * parser.acceptsAll(Arrays.asList("un",
             * "user-name")).withRequiredArg().ofType(String.class).required();
             * ArgumentAcceptingOptionSpec<String> sessionIdOption =
             * parser.acceptsAll(Arrays.asList("sid",
             * "session-id")).withRequiredArg().ofType(String.class).required();
             * ArgumentAcceptingOptionSpec<String> downloadTicketOption =
             * parser.acceptsAll(Arrays.asList("dlt",
             * "download-ticket")).withRequiredArg
             * ().ofType(String.class).defaultsTo("deprecated");
             * ArgumentAcceptingOptionSpec<String> lastVersionOption =
             * parser.acceptsAll(Arrays.asList("lv",
             * "latest-version")).withRequiredArg
             * ().ofType(String.class).required();
             * ArgumentAcceptingOptionSpec<Boolean> demoOption =
             * parser.acceptsAll(Arrays.asList("dm",
             * "demo-game")).withOptionalArg
             * ().ofType(Boolean.class).defaultsTo(false);
             * ArgumentAcceptingOptionSpec<Boolean> changeOptionsOption =
             * parser.acceptsAll(Arrays.asList("ap",
             * "applet-parameters")).withOptionalArg
             * ().ofType(Boolean.class).defaultsTo(false);
             * ArgumentAcceptingOptionSpec<File> gameDirOption =
             * parser.acceptsAll(Arrays.asList("dir",
             * "game-directory")).withRequiredArg
             * ().ofType(File.class).defaultsTo
             * (Platform.getCurrentPlatform().getWorkingDirectory());
             * ArgumentAcceptingOptionSpec<File> gameJarOption =
             * parser.acceptsAll(Arrays.asList("jar",
             * "game-file")).withRequiredArg().ofType(File.class).required();
             * ArgumentAcceptingOptionSpec<File[]> gameFilesOption =
             * parser.acceptsAll(Arrays.asList("lib",
             * "game-libraries")).withRequiredArg
             * ().ofType(File[].class).required();
             * ArgumentAcceptingOptionSpec<String> multiplayerOption =
             * parser.acceptsAll(Arrays.asList("mp",
             * "multiplayer")).withRequiredArg().ofType(String.class);
             * ArgumentAcceptingOptionSpec<Integer> widthOption =
             * parser.acceptsAll(Arrays.asList("w",
             * "window-width")).withRequiredArg
             * ().ofType(Integer.class).defaultsTo(800);
             * ArgumentAcceptingOptionSpec<Integer> heightOption =
             * parser.acceptsAll(Arrays.asList("h",
             * "window-height")).withRequiredArg
             * ().ofType(Integer.class).defaultsTo(600);
             * ArgumentAcceptingOptionSpec<Boolean> maximizeOption =
             * parser.acceptsAll(Arrays.asList("m",
             * "maximize-window")).withOptionalArg
             * ().ofType(Boolean.class).defaultsTo(false);
             * ArgumentAcceptingOptionSpec<String> argsOption =
             * parser.acceptsAll
             * (Arrays.asList("args","additional-parameters")).withRequiredArg
             * ().ofType(String.class);
             * 
             * OptionSet options = parser.parse(args);
             * 
             * String userName = options.valueOf(userNameOption); String
             * sessionID = options.valueOf(sessionIdOption); String lastVer =
             * options.valueOf(lastVersionOption); String dlTicket =
             * options.valueOf(downloadTicketOption);
             * 
             * File gameDir = options.valueOf(gameDirOption); int w =
             * options.valueOf(widthOption); int h =
             * options.valueOf(heightOption); boolean maximize =
             * options.valueOf(maximizeOption); boolean demo =
             * options.valueOf(demoOption); boolean changeOptions =
             * options.valueOf(changeOptionsOption); File gameFile =
             * options.valueOf(gameJarOption); File[] libraries =
             * options.valueOf(gameFilesOption);
             */
